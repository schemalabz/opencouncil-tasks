...

{
    ...
    locationText:  string | null; // Αν το θέμα αναφέρεται σε κάποια συγκεκριμένη τοποθεσία (π.χ. διεύθυνση, δρόμος, γειτονιά, ή συγκεκριμένη επιχείρηση / δημόσια δομή), η διεύθυνση του θέματος, ΑΚΡΙΒΩΣ όπως γράφεται στο έγγραφο και στη γλώσσα του εγγράφου — μη μεταφράζεις, μη μεταγράφεις και μην προσθέτεις πόλη ή χώρα. Αν το θέμα δεν έχει τοποθεσία, ή αφορά ολόκληρο το δήμο (π.χ. ο προϋπολογισμός του Δήμου), τότε null
