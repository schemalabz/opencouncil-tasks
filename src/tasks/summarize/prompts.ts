...
- Οδός με αριθμό, γειτονιά/συνοικία, πλατεία, πάρκο, ή συγκεκριμένο κτίριο / δημόσια δομή
- Γράψε το τοπωνύμιο ΑΚΡΙΒΩΣ όπως ειπώθηκε, στη γλώσσα της συνεδρίασης — ΜΗΝ το μεταφράζεις και ΜΗΝ το μεταγράφεις σε άλλο αλφάβητο
- ΜΗΝ προσθέτεις πόλη, περιοχή ή χώρα — μπαίνουν αυτόματα αργότερα
