...
- ΣΗΜΑΝΤΙΚΟ: Το agendaItemIndex είναι ήδη σωστό - ΜΗΝ το αλλάξεις
  * Οι ημερήσιες διατάξεις χρησιμοποιούν 1-based numbering (1, 2, 3...)
...
- OUT_OF_AGENDA: κατεπείγον που ΑΠΟΡΡΙΦΘΗΚΕ από το σώμα ή αναβλήθηκε/αποσύρθηκε μετά τη συζήτηση
- ΠΟΤΕ μαζί με discussedIn: αν ένα θέμα συζητείται ως μέρος άλλου θέματος, ΔΕΝ είναι withdrawn

agendaItemIndex:
- Αριθμός (1, 2, 3...) για IN_AGENDA - οι ημερήσιες διατάξεις αρχίζουν από το 1
...
- Διεύθυνση: «Λεωφόρος Μεσογείων 45», «Rue de la République 12»
- Γειτονιά: «Εξάρχεια», «Novi Beograd»
- Επώνυμος δημόσιος χώρος: «Πλατεία Συντάγματος», «Trg republike»
- Γράψε ΜΟΝΟ το τοπωνύμιο, όπως ακριβώς ειπώθηκε. ΜΗΝ προσθέτεις πόλη, περιοχή ή χώρα — μπαίνουν αυτόματα αργότερα
- ΕΞΑΙΡΕΣΗ ΓΛΩΣΣΑΣ (ισχύει ΜΟΝΟ για το locationText, όχι για τα υπόλοιπα πεδία): κράτα το τοπωνύμιο στη γλώσσα και το αλφάβητο που χρησιμοποιεί το πρακτικό — ΜΗΝ μεταφράζεις και ΜΗΝ μεταγράφεις μεταξύ αλφαβήτων
...
PROCEDURAL_VOTE:
- Ψηφοφορία ένταξης κατεπείγοντος ή απόσυρση/αναβολή θέματος
- ΘΕΜΕΛΙΩΔΗΣ ΚΑΝΟΝΑΣ: Από τη στιγμή που εισάγεται ένα εκτός ημερησίας θέμα (κατεπείγον) μέχρι τη στιγμή
  ...
  την έγκριση ένταξης.
- subjectId: ΠΑΝΤΑ (ποτέ null) — δημιούργησε ή αναφέρσου στο σχετικό subject
