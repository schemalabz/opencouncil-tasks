...
ΚΡΙΣΙΜΟ - BEFORE_AGENDA SUBJECTS ΠΡΕΠΕΙ ΝΑ ΕΙΝΑΙ ΣΥΓΚΕΚΡΙΜΕΝΑ:
- ΜΗΝ δημιουργείς γενικά subjects όπως "Ερωτήματα και ανακοινώσεις προ ημερησίας" που συνδυάζουν πολλά θέματα
- Κάθε ερώτημα ή ανακοίνωση πρέπει να έχει το ΔΙΚΟ ΤΟΥ subject
- ΣΩΣΤΟ: "Ερώτημα για γεωργικά θέματα", "Ανακοίνωση για γραφείο ενεργειακής φτώχειας"
- ΛΑΘΟΣ: "Ερωτήματα προ ημερησίας", "Ανακοινώσεις"
- Αν βλέπεις 3 διαφορετικά ερωτήματα προ ημερησίας, δημιούργησε 3 ξεχωριστά subjects
