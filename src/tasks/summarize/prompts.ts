...
description (3-5 προτάσεις, markdown με λίγα references):

ΣΚΟΠΟΣ DESCRIPTION:
Η description πρέπει να ορίζει ΞΕΚΑΘΑΡΑ το εύρος του θέματος: τι ακριβώς καλύπτει και τι όχι.
Αυτό είναι κρίσιμο γιατί χρησιμοποιείται αργότερα για αποφυγή διπλών θεμάτων.

ΣΤΥΛ:
- Φυσική αφηγηματική ροή, όχι λίστες
- ΧΡΗΣΙΜΟΠΟΙΗΣΕ ΟΝΟΜΑΤΑ: "Ο Παπαδόπουλος ρωτάει...", "Η Κωνσταντίνου ανέφερε..."
...
ΔΟΜΗ:
1. Τι είναι το θέμα, τι ακριβώς καλύπτει, ποιο είναι το εύρος του (χωρίς reference)
2. Τι συζητήθηκε/τέθηκε (με reference μόνο για κύριο claim) - χρησιμοποίησε ονόματα ομιλητών
...
ΑΠΛΟ ΘΕΜΑ:
"Προμήθεια υλικών για τρία δημοτικά σχολεία (3ο, 7ο, 12ο Δημοτικό). Ο Νικολάου εξήγησε ότι [η προμήθεια περιλαμβάνει θρανία και διαδραστικούς πίνακες](REF:UTTERANCE:xxx) και το κόστος καλύπτεται από τον τακτικό προϋπολογισμό. Εγκρίθηκε ομόφωνα."

ΠΡΟ ΗΜΕΡΗΣΙΑΣ ΘΕΜΑ:
"Ερώτημα για τις καθυστερήσεις στα οδικά έργα της Λ. Αλεξάνδρας, ειδικά στο τμήμα μεταξύ Πατησίων και Κηφισίας. Ο Δημητρίου ρωτάει [πότε θα ολοκληρωθεί η β' φάση των εργασιών](REF:UTTERANCE:xxx). Ο Γεωργίου απαντάει ότι η εργολαβία είναι σε φάση παράδοσης."

ΠΟΛΥΠΛΟΚΟ:
"Ρύθμιση κυκλοφορίας στο εμπορικό κέντρο, συγκεκριμένα πεζοδρόμηση της οδού Ερμού και μονοδρομήσεις γύρω πλατείες. Η συζήτηση επικεντρώθηκε στην ισορροπία μεταξύ προστασίας εμπορίου και ποιότητας ζωής. Εγκρίθηκε με αποχή της αντιπολίτευσης.

Κύρια ζητήματα:
- Η Αθανασίου ζητά μελέτη επίπτωσης στα τοπικά καταστήματα
- Ο Παπαδόπουλος απαντάει ότι [η μελέτη θα ολοκληρωθεί σε τρεις μήνες](REF:UTTERANCE:xxx)
- Ο Βασιλείου θέτει ζήτημα διαβούλευσης με τους εμπόρους πριν την εφαρμογή"
