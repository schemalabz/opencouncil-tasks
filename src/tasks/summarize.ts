...
import { convertRangesToUtteranceStatuses, buildUtteranceIndexMap } from "./summarize/utils.js";
...
export const summarize: Task<SummarizeRequest, SummarizeResult> = async (request, onProgress) => {
    ...
    const { speakerSegmentSummaries, subjects, allDiscussionRanges, usage: phase1Usage } =
